...
def enforcement_year_month(year, month):
  ...
  #since it is, continue by initializing scraper
  else:
    ...
    while date >=  test_date:
      ...
      #removing categories that caused doubles and never appeared on their own
      if page == 23:
        category.pop(-3)
      for c in category:
          if c == "COVID-19" or c == 'EMTALA/Patient Dumping':
            pass
          else:
            categories.append(c)
      print(page, len(categories))
...
#test = enforcement_year_month(2024, 6)
january = enforcement_year_month(2023, 1)
print(len(january))
print(january.iloc(-1))
...
links = []
titles = []
url = "https://oig.hhs.gov/fraud/enforcement/?page=23"
