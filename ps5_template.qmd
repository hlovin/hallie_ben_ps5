...
```{python}
import os
path = r"/Users/benschiffman/Desktop/Python 2/hallie_ben_ps5/"
relative_path = r"enforcement_actions_2021_1.csv"
jan2021 = pd.read_csv(os.path.join(path, relative_path))
